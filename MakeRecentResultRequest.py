...
async def make_recent_results_request(session, token, date):
    url = "https://usaswimming.sisense.com/api/datasources/USA%20Swimming%20Times%20Elasticube/jaql?trc=sdk-ui-1.23.0"

    payload = json.dumps({"metadata":[{"jaql":{"title":"Name","dim":"[UsasSwimTime.FullName]","datatype":"text"}},
            ...
            {"jaql":{"title":"Swim Date", "dim":"[SeasonCalendar.CalendarDate (Calendar)]", "sort": "asc", "datatype":"datetime","level":"days", "filter":{"members":[date]}}, "format":{"mask":{"days":"MM/dd/yyyy"}}},
